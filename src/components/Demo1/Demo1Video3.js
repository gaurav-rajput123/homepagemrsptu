        ...
        <div className="container white-color">
          <div id="video-3-content" className="row">
            <div className="col-lg-8 offset-lg-2 video-txt text-center">
              {/* Title */}
              <h3 className="h3-md">
              MRSPTU,Bathinda announces 75 online certification courses
              </h3>
              {/* Text */}
              <p className="p-lg">
              The Governor of Punjab and Chief Minister of Punjab launched online certificate courses in league with the emerging technologies.
              </p>
            </div>
          </div>
        </div>
