                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="section-title title-centered mb-80">
                            ...
                            {/* Button 
									<div class="title-btn">
										<Link href='/categories-list'><a  className='btn btn-tra-grey rose-hover'>Browse All Categories</a></Link>
									</div> */}
                        </div>
                    </div>
                </div>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="c4-box">
                            ...
                            <div className="c4-box-ico mb-15 clearfix">
                                ...
                                <h5 className="h5-md">IT & Software Development</h5>
                                <p>341 Courses</p>
                            </div>
                            {/* List */}
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="c4-box">
                            ...
                            <div className="c4-box-ico mb-15 clearfix">
                                ...
                                <h5 className="h5-md">Networking</h5>
                                <p>268 Courses</p>
                            </div>
                            {/* List */}
                            <div className="c4-box-txt">
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="c4-box">
                            ...
                            <div className="c4-box-ico mb-15 clearfix">
                                ...
                                <h5 className="h5-md">Programming Language</h5>
                                <p>179 Courses</p>
                            </div>
                            {/* List */}
                            <div className="c4-box-txt">
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="c4-box">
                            ...
                            <div className="c4-box-ico mb-15 clearfix">
                                ...
                                <h5 className="h5-md">Patents & Intellectual Property Rights</h5>
                                <p>370 Courses</p>
                            </div>
                            {/* List */}
                            <div className="c4-box-txt">
