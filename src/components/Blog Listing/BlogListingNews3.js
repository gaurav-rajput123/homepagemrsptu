                  ...
                  <div className="article-3 row d-flex align-items-center b-bottom">
                    ...
                    <div className="col-md-8">
                      ...
                      <p style={{ textAlign: 'justify' }}>
                        ...
                        might result from a lack of education. Education is important in many...
                      </p>
                      {/* Post Tags */}
                ...
                <div>
                  <div className="article-3 row d-flex align-items-center b-bottom">
                    ...
                    <div className="col-md-8">
                      ...
                      {/* Text */}
                      <p style={{ textAlign: 'justify' }}>
                      A professional course is a learning experience that equips you with the abilities necessary to do tasks related to your profession. A professional course is a highly specialized and hands-on training programme designed for working...
                      </p>
                      {/* Post Tags */}
                      <div className="tags-cloud">
                        <span className="badge">
